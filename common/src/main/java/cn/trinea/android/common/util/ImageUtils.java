...
public class ImageUtils {
     ...
     * @return
     * @see cn.trinea.android.common.util.ImageUtils#getInputStreamFromUrl(String, int, boolean)
     */
     ...
     * @param readTimeOutMillis
     * @return
     * @see cn.trinea.android.common.util.ImageUtils#getDrawableFromUrl(String, int, boolean)
     */
     ...
     * @param readTimeOut
     * @return
     * @see cn.trinea.android.common.util.ImageUtils#getBitmapFromUrl(String, int, boolean)
     */
