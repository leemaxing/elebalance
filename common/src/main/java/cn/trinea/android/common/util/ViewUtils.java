 ...
 * <li>{@link cn.trinea.android.common.util.ViewUtils#getListViewHeightBasedOnChildren(android.widget.ListView)}</li>
 * <li>{@link cn.trinea.android.common.util.ViewUtils#getAbsListViewHeightBasedOnChildren(android.widget.AbsListView)}</li>
 * </ul>
 * <ul>
 * <strong>set view height</strong>
 * <li>{@link cn.trinea.android.common.util.ViewUtils#setViewHeight(android.view.View, int)} set view height</li>
 * <li>{@link cn.trinea.android.common.util.ViewUtils#setListViewHeightBasedOnChildren(android.widget.ListView)}</li>
 * <li>{@link cn.trinea.android.common.util.ViewUtils#setAbsListViewHeightBasedOnChildren(android.widget.AbsListView)}</li>
 * </ul>
 * <ul>
 * <strong>get other info</strong>
 * <li>{@link cn.trinea.android.common.util.ViewUtils#getGridViewVerticalSpacing(android.widget.GridView)} get GridView vertical spacing</li>
 * </ul>
 * <ul>
 * <strong>set other info</strong>
 * <li>{@link cn.trinea.android.common.util.ViewUtils#setSearchViewOnClickListener(android.view.View, android.view.View.OnClickListener)}</li>
 * </ul>
 * 
