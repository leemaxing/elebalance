...
import com.liicon.utils.cache.ImageLruCache;
...
public class AbImageLoader { 
    ...
    public AbImageLoader(Context context) {
    	...
    	mQueue = Volley.newRequestQueue(context, new File(FileManager.getCacheDirByUsable(context.getPackageName(), "images")));
    	mImageLoader = new ImageLoader(mQueue, ImageLruCache.getInstance(context));
    }
