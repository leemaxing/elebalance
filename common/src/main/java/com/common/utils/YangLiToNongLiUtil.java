 ...
 * 农历(阴历)工具类
 * 
 * @version v0.1 king 2014-11-4 TODO
 */
public class YangLiToNongLiUtil {
	 ...
	 * 构造一个表示指定日期的农历日历
	 */
	public YangLiToNongLiUtil(Date date) {
	 ...
	 * @param cal
	 */
	public YangLiToNongLiUtil(Calendar cal) {
