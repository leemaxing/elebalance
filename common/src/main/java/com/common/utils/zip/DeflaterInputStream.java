...
import from.libcore.io.Streams;


/**
 * 为使用 "deflate" 压缩格式压缩数据实现输入流过滤器。
 * @version  v0.1  king  2014-11-6  参考AndroidSKD
 */
public class DeflaterInputStream extends FilterInputStream {
     ...
     * {@link java.io.InputStream#available()}, and violates the <a
