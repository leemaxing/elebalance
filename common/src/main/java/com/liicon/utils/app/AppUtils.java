...
/**
 * APP辅助工具类
 * @version  v0.1  king  2014-12-22  获取已安装APP信息
 */
public class AppUtils {
    
    /**
     * APP信息
     * @version  v0.1  king  2014-12-22  APP信息
     */
    public static class AppInfo {
        ...
        private AppInfo(Context context, PackageInfo packageInfo) {
            super();
            this.appName = StringUtils.toString(packageInfo.applicationInfo.loadLabel(context.getPackageManager()));
    ...
    public static List<AppInfo> getInstalledApps(Context context) {
        ...
        List<AppInfo> appInfoList = new ArrayList<AppInfo>(); // 用来存储获取的应用信息数据
        for (int i = 0; i < packages.size(); i++) {
            PackageInfo packageInfo = packages.get(i);
            appInfoList.add(new AppInfo(context, packageInfo));
        }
        return appInfoList;
    }
    ...
    public static AppInfo getCurrentAppInfo(Context context) {
        ...
        if (packageInfo == null) {
            return new AppInfo(context, packageInfo);
        }
        return new AppInfo(context, packageInfo);
    }
    ...
    public static class ShareAppInfo {
        ...
        private ShareAppInfo(Context context, ResolveInfo resolveInfo) {
//            super(context, packageInfo);
            ...
            this.appName = StringUtils.toString(applicationInfo.loadLabel(context.getPackageManager()));
    ...
    public static List<ShareAppInfo> getShareApps(Context context) {
        ...
        for (int i = 0; i < resolveList.size(); i++) {
            ...
            ShareAppInfo shareAppInfo = new ShareAppInfo(context, resolve);
