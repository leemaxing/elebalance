 ...
 * @version  v0.1  king  2014-12-23  SharedPreferences读写操作
 */
public class PreferencesUtils {

    public static final String PREFERENCE_NAME = "settings_share";
    
    /**
     * 获取默认的SharedPreferences配置存储对象
