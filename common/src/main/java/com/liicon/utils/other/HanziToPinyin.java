...
public class HanziToPinyin {
	...
	public static HanziToPinyin getInstance() {
		synchronized (HanziToPinyin.class) {
            ...
            LLog.i("There is no Chinese collator, HanziToPinyin is disabled");
	...
	private static boolean doSelfValidation() {
		...
		for (char c : UNIHANS) {
			...
			if (cmp >= 0) {
                LLog.e("Internal error in Unihan table. "
	 ...
	 * @return
	 */
	public static List<Token> getPinYin(String source) {
