...
public class NextProtoNego {
	...
	/**
	 * @param socket
	 *            a socket registered with {@link #put(javax.net.ssl.SSLSocket, from.org.eclipse.jetty.npn.NextProtoNego.Provider)}
	 ...
	 * 
	 * @param engine
	 *            an engine registered with {@link #put(javax.net.ssl.SSLEngine, from.org.eclipse.jetty.npn.NextProtoNego.Provider)}
