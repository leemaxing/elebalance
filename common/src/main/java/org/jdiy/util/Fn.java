...
public class Fn {
    /**
     * 时间间隔枚举.
     * 此枚举供{@link org.jdiy.util.Fn#dateadd(org.jdiy.util.Fn.interval, int, java.util.Date)}和
     * {@link org.jdiy.util.Fn#datediff(org.jdiy.util.Fn.interval, java.util.Date, java.util.Date)}方法的参数调用.
     */
