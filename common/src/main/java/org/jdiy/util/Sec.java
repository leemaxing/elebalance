...
import org.jdiy.core.ex.JDiySecurityException;
...
public class Sec {
    ...
    public static String AESDecrypt(String encrypted, String rawKey){
        ...
        try {
            ...
            throw new JDiySecurityException(e.getCause(), "EE0050", "AES", e.getMessage());
        }
    }
    ...
    public static String AESEncrypt(String message, String rawKey){
        ...
        try {
            ...
            throw new JDiySecurityException(e.getCause(), "EE0049","AES", e.getMessage());
        }
    }
    ...
    public static String DESDecrypt(String encrypted, String rawKey){
    	// TODO Security.addProvider(new com.sun.crypto.provider.SunJCE());
        ...
        try {
            ...
            throw new JDiySecurityException(e.getCause(), "EE0050", "DES", e.getMessage());
        }
    }
    ...
    public static String DESEncrypt(String message, String rawKey) {
        ...
        try {
            ...
            throw new JDiySecurityException(e.getCause(), "EE0049", "DES", e.getMessage());
        }
    }
    ...
    public static String MD5Encrypt(String message, int length){
        try {
            ...
            else throw new JDiySecurityException("EE0051");
        } catch (Exception e) {
            throw new JDiySecurityException(e.getCause(), "EE0049","MD5", e.getMessage());
        }
    }
