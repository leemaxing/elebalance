...
public final class KJLoger {
    public static boolean IS_DEBUG = KJConfig.isDebug;
    public static boolean DEBUG_LOG = KJConfig.isDebug;
    public static boolean SHOW_ACTIVITY_STATE = KJConfig.isDebug;
