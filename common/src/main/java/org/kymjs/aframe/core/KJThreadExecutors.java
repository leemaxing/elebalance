...
public class KJThreadExecutors {
     ...
     * explicitly {@link java.util.concurrent.ExecutorService#shutdown shutdown}.
     * 
     * @param nThreads
    ...
    /**
     * Returns an object that delegates all defined {@link java.util.concurrent.ExecutorService}
     ...
     * {@link java.util.concurrent.ScheduledExecutorService} methods to the given executor, but not
    ...
    /**
     * Returns a {@link java.util.concurrent.Callable} object that, when called, runs the given task
    ...
    /**
     * Returns a {@link java.util.concurrent.Callable} object that, when called, runs the given
    ...
    /**
     * Returns a {@link java.util.concurrent.Callable} object that will, when called, execute the
