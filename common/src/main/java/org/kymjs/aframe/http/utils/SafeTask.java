...
public abstract class SafeTask<Params, Progress, Result> extends
    ...
    /**
     * 取代了{@link android.os.AsyncTask#onPreExecute()}, 这个方法的任意异常都能被捕获：它是安全的。<br>
    ...
    /**
     * Child Thread<br>
     * 取代了{@link android.os.AsyncTask#doInBackground(Object...)}, 这个方法的任意异常都能被捕获：它是安全的。
    ...
    /**
     * Main UI Thread<br>
     * 用于取代{@link android.os.AsyncTask#onPostExecute(Object)}。<br>
    ...
    /**
     * Main UI Thread<br>
     * 用于取代{@link android.os.AsyncTask#onProgressUpdate(Object...)},<br>
     * 这个方法的任意异常都能被捕获：它是安全的。<br>
     * 
     * @param values
     *            更新传递的值
     */
    protected void onProgressUpdateSafely(Progress... values)
            throws Exception {}
}
