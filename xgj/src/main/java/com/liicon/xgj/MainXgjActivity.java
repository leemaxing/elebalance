...
public class MainXgjActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.main_xgj);
	...
	private void init(){
        ...
        mListMenu.getViewPager().getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() {
            ...
            public boolean onPreDraw() {
                ...
                MenuPagerAdapter adapter = new MenuPagerAdapter(MainXgjActivity.this, datas, widthViewPager, heightViewPager);
